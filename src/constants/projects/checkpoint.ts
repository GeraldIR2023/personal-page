...
export const checkpointLogs: Trophy[] = [
    {
        ...
        requirement: "Achieved 100% completion of the Checkpoint Ecosystem.",
        description:
    ...
    },
    {
        ...
        title: "Transaction Overlord",
        requirement:
            "Engineered the complete transaction and billing engine for secure order processing.",
        description:
    ...
    },
    {
        ...
        title: "The Messenger",
        requirement:
            "Integrated automated email notifications for user onboarding via Mailtrap.",
        description:
    ...
    },
    {
        ...
        requirement:
            "Mastered the Full-Stack Connection, linking complex API endpoints with the frontend.",
        description:
    ...
    {
        id: "the-overseer",
        title: "The Overseer (Admin Panel)",
        requirement:
            "Developed a comprehensive Command Center to manage inventory and users.",
        description:
    ...
    {
        id: "database-warden",
        title: "Database Warden",
        requirement:
            "Implemented a complete CRUD architecture with PostgreSQL for 100% data reliability.",
        description:
    ...
    },
    {
        ...
        title: "Guard & Shield",
        requirement:
            "Secured the platform using JWT, custom Guards, and secure Cookies.",
        description:
    ...
    },
    {
        ...
        requirement:
            "Built a modular library of Reusable UI Components and Server Actions in Next.js.",
        description:
    ...
    },
    {
        ...
        title: "The Navigator",
        requirement:
            "Designed a multi-level Catalog System with advanced filtering.",
        description:
    ...
    },
    {
        ...
        requirement:
            "Created all core Backend Resources for Users, Games, Categories, and Coupons.",
        description:
    ...
    },
    {
        ...
        title: "Feedback Specialist",
        requirement:
            "Enhanced UX by implementing real-time notifications with Sonner and Toastify.",
        description:
    ...
    },
    {
        ...
        title: "The Sentinel",
        requirement:
            "Developed strict Data Validation layers for Frontend forms and Backend DTOs.",
        description:
